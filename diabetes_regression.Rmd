...
diabetes_rg_interactive = subplot(
  ...
  layout(
    annotations = list(
      list(
        x = 0.16, y = 1.07,
        text = "<b>Glycohemoglobin vs Caffeine</b>",
